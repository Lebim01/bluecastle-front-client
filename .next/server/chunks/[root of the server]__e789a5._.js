...
"[project]/src/services/index.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/user.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/index.ts [api] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
const login = async (email, password)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].post("/auth/login", {
        email,
        password
    }).then((r)=>{
        return r.data;
...
const signUp = async (profile)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].post("/auth/register", {
        email: profile.email,
...
const signUpSocial = async (profile)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].post("/auth/register/social", {
        email: profile.email,
        password: profile.password,
        name: profile.firstName,
        lastname: profile.lastName,
...
const existsByEmail = async (email)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].post("/auth/exists-email", {
        email
    }).then((r)=>{
        if (r.data == false) {
...
const authMe = async (token)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].get("/users/me", {
        headers: {
...
const updateUser = async (user)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].patch("/auth/update", user).then((r)=>r.data);
};
const updatePassword = async (password)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].post("users/update/password", {
        password
    });
};
const recoverPassword = async ({ email, password, otp })=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].post("users/recover/password", {
        email,
        password,
        otp
    });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/user.ts [api] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/index.ts [api] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$api$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$api$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
        ...
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$providers$2f$credentials__$5b$external$5d$__$28$next$2d$auth$2f$providers$2f$credentials$2c$__cjs$29$__["default"])({
            ...
            async authorize (credentials, req) {
                if (credentials?.username && credentials.password) {
                    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["login"])(credentials.username, credentials.password);
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$index$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].defaults.headers.Authorization = "Bearer " + token;
                    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["authMe"])(token);
                    return user;
                }
                return null;
            }
    ...
    callbacks: {
      ...
      if (isExpired) {
        throw new Error("Expired");
                ...
                const authme = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["authMe"])(token?.accessToken);
                session.user = authme;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/pages/api/auth/[...nextauth].ts [api] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e789a5._.js.map